...
Relative image paths in the Markdown (``../outputs/figures/...``) are resolved
against the report directory through a pisa ``link_callback``.
"""
...
OUTPUT_PDF = (
    REPORT_DIR / "anderson_correa_sistemas-cognitivos-linguagem-natural_pln.pdf"
)
